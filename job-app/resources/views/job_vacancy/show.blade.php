        ...
        <div class="p-6 mx-auto bg-black rounded-lg shadow-lg sm:p-6 max-w-7xl">
            ...
            <div class="pb-6 border-b border-white/10">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <a href="{{ route('job_vacancy.apply', $job_vacancies->id) }}" class="justify-center px-4 py-2 text-white transition rounded-lg bg-gradient-to-r from-indigo-500 to-rose-500 hover:from-indigo-600 hover:to-rose-600">Apply Now</a>
                    </div>
                </div>
            </div>
            {{-- start grid --}}
